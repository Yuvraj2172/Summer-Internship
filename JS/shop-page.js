...
const totalItems=document.querySelector('#cart-count-info')
...
(function () {
    ...
    // console.log(typeof totalItemsCart.textContent)
...
function calculateTotal() {    let total =0;
    items.forEach(item =>{
        total += item.no;
    });
...
// setInterval(function(){totalItems.innerHTML = total},1000);
